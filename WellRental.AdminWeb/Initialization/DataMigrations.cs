namespace WellRental.AdminWeb
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want WellRental.AdminWeb migrations to run on your DB.
            if (!isOracle && cs.ConnectionString.IndexOf(typeof(DataMigrations).Namespace , StringComparison.OrdinalIgnoreCase) < 0)
            {
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "WellRental.AdminWeb.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
