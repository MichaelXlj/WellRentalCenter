namespace WellRental.AdminWeb.BasicSamples {
    export namespace CustomerGrossSalesService {
        ...
        export declare function List(request: CustomerGrossSalesListRequest, onSuccess?: (response: Serenity.ListResponse<AdminWeb.Northwind.CustomerGrossSalesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
