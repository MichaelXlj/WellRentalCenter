...
namespace MVC
{
    public static class Views
    {
        ...
        public static class WellRentalCenter
        {
            public static class Assignment
            {
                public const string AssignmentIndex = "~/Modules/WellRentalCenter/Assignment/AssignmentIndex.cshtml";
            }

            public static class City
            {
                public const string CityIndex = "~/Modules/WellRentalCenter/City/CityIndex.cshtml";
            }

            public static class District
            {
                public const string DistrictIndex = "~/Modules/WellRentalCenter/District/DistrictIndex.cshtml";
            }

            public static class Merchant
            {
                public const string MerchantIndex = "~/Modules/WellRentalCenter/Merchant/MerchantIndex.cshtml";
            }

            public static class MerchantType
            {
                public const string MerchantTypeIndex = "~/Modules/WellRentalCenter/MerchantType/MerchantTypeIndex.cshtml";
            }

            public static class Order
            {
                public const string OrderIndex = "~/Modules/WellRentalCenter/Order/OrderIndex.cshtml";
            }

            public static class Payment
            {
                public const string PaymentIndex = "~/Modules/WellRentalCenter/Payment/PaymentIndex.cshtml";
            }

            public static class Province
            {
                public const string ProvinceIndex = "~/Modules/WellRentalCenter/Province/ProvinceIndex.cshtml";
            }

            public static class Remission
            {
                public const string RemissionIndex = "~/Modules/WellRentalCenter/Remission/RemissionIndex.cshtml";
            }

            public static class WxOpenUser
            {
                public const string WxOpenUserIndex = "~/Modules/WellRentalCenter/WxOpenUser/WxOpenUserIndex.cshtml";
            }
